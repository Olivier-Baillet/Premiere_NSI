...
![image](https://glassus.github.io/premiere_nsi/T2_Representation_des_donnees/2.6_Codage_caracteres/data/BO.png)

## 1. Au commencement était l'ASCII

pour *American Standard Code for Information Interchange*, créé en 1960 aux États-Unis.

![](https://glassus.github.io/premiere_nsi/T2_Representation_des_donnees/2.6_Codage_caracteres/data/ascii.png)
...
![](https://glassus.github.io/premiere_nsi/T2_Representation_des_donnees/2.6_Codage_caracteres/data/iso-latin.png)
...
Le fichier `test.txt` contient un texte enregistré avec l'encodage Latin-9.
...
![](https://glassus.github.io/premiere_nsi/T2_Representation_des_donnees/2.6_Codage_caracteres/data/hexa_latin.png)
...
![](https://glassus.github.io/premiere_nsi/T2_Representation_des_donnees/2.6_Codage_caracteres/data/isogrec.png)
...
![](https://glassus.github.io/premiere_nsi/T2_Representation_des_donnees/2.6_Codage_caracteres/data/isothai.png)
...
![](https://glassus.github.io/premiere_nsi/T2_Representation_des_donnees/2.6_Codage_caracteres/data/erreur_nav.png)

Normalement, pour un navigateur, une page web correctement codée doit contenir dans une balise `meta` le `charset` utilisé.

![](https://glassus.github.io/premiere_nsi/T2_Representation_des_donnees/2.6_Codage_caracteres/data/source_twitter.png)
...
![](https://glassus.github.io/premiere_nsi/T2_Representation_des_donnees/2.6_Codage_caracteres/data/exo2.png)

</aside>

## 4. Enfin une normalisation : l'arrivée de l'UTF

![image](https://glassus.github.io/premiere_nsi/T2_Representation_des_donnees/2.6_Codage_caracteres/data/meme.jpg)
...
![](https://glassus.github.io/premiere_nsi/T2_Representation_des_donnees/2.6_Codage_caracteres/data/slogan_unicode.png)
...
Pourquoi est-ce encore si compliqué ? En UTF-32, 32 bits sont disponibles, soit  caractères différents encodables.
...
![](https://glassus.github.io/premiere_nsi/T2_Representation_des_donnees/2.6_Codage_caracteres/data/cap_utf8.png)
...
**Pourquoi le caractère `é` en UTF-8 devient-il `Ã©` en ISO 8859-15 ?**

![image](https://glassus.github.io/premiere_nsi/T2_Representation_des_donnees/2.6_Codage_caracteres/data/zefede.png)
...
![](https://glassus.github.io/premiere_nsi/T2_Representation_des_donnees/2.6_Codage_caracteres/data/graph_comparaison.png)