...
![image](https://glassus.github.io/premiere_nsi/T1_Demarrer_en_Python/1.5_Fonctions/data/meme.jpg)
...
![image](https://glassus.github.io/premiere_nsi/T1_Demarrer_en_Python/1.5_Fonctions/data/f1.png)
...
![image](https://glassus.github.io/premiere_nsi/T1_Demarrer_en_Python/1.5_Fonctions/data/f2.png)
...
![image](https://glassus.github.io/premiere_nsi/T1_Demarrer_en_Python/1.5_Fonctions/data/f3.png)

On retrouve ici la notion classique de fonction rencontrée en mathématiques : un procédé qui prend un nombre et en renvoie un autre. En informatique, l'objet renvoyé ne sera pas forcément un nombre (cela pourra être aussi une liste, un tableau, une image...). Le renvoi d'une valeur se fait grâce au mot-clé `return`.

#### **Exemple fondateur n°3**

La fonction mathématique  se codera par :
...
> 
> Le mot-clé `return` de l'exemple précédent fait que l'expression `f(10)` est **égale** à 23. On peut d'ailleurs écrire en console :
> 
> ```python
> >>> f(10) + 5
> 28
> ```
> 
> Imaginons (avant de l'oublier très vite) le code
> 
> **affreux**
> 
> ci-dessous :
...
> ```
> 
> Mais `g` se contente **d'afficher** sa valeur calculée, et non pas de la renvoyer.
> En effet :
> 
> ```python
> >>> g(10) + 5
...
> En résumé :
> 
> ![image](https://glassus.github.io/premiere_nsi/T1_Demarrer_en_Python/1.5_Fonctions/data/yoda.png)
> 
> </aside>
> 
...
![image](https://glassus.github.io/premiere_nsi/T1_Demarrer_en_Python/1.5_Fonctions/data/global_regles.png)
...
![](https://glassus.github.io/premiere_nsi/T1_Demarrer_en_Python/1.5_Fonctions/data/global_meme.jpg)
...
![image](https://glassus.github.io/premiere_nsi/T1_Demarrer_en_Python/1.5_Fonctions/data/tests.png)
...
**Q2.** Écrire la fonction `fizzbuzz`. (Vous pouvez vous inspirer fortement du code de l'exercice 2 du chapitre précédent )