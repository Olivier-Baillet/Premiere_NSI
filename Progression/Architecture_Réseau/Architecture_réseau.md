...
![image](https://glassus.github.io/premiere_nsi/T3_Architecture_materielle/3.3_Architecture_reseau/data/BO.png)
...
Installation de la version 2.10.1 pour nos machines virtuelles :

- Télécharger le fichier [Filius](https://www.lernsoftware-filius.de/downloads/Setup/Filius-Setup_with-JRE-2.10.1.exe)
- Dans un terminal ouvert dans le dossier Téléchargements, taper `sudo dpkg -i filius_2.4.0_all.deb`
</aside>

![](https://glassus.github.io/premiere_nsi/T3_Architecture_materielle/3.3_Architecture_reseau/data/f1.png)
...
- **Résultat du ping**
    ...
    ![](https://glassus.github.io/premiere_nsi/T3_Architecture_materielle/3.3_Architecture_reseau/data/ft1.png)
...
Cette adresse est codée sur 48 bits, présentés sous la forme de 6 octets en hexadécimal.
Exemple : `fc:aa:14:75:45:a5`

Les trois premiers octets correspondent au code du fabricant.
Un site comme  [https://www.macvendorlookup.com/](https://www.macvendorlookup.com/) vous permet de retrouver le fabricant d'une adresse MAC quelconque.

## 1.2. Switch, hub, quelle différence ?

Au sein d'un **hub Ethernet** (de moins en moins vendus), il n'y a **aucune analyse** des données qui transitent :
Il s'agit simplement d'un dédoublement des fils de cuivre (tout comme une multiprise électrique). L'intégralité des messages est donc envoyée à l'intégralité des ordinateurs du réseau, même s'ils ne sont pas concernés.

![](https://glassus.github.io/premiere_nsi/T3_Architecture_materielle/3.3_Architecture_reseau/data/hub.png)
...
![](https://glassus.github.io/premiere_nsi/T3_Architecture_materielle/3.3_Architecture_reseau/data/switch.png)

# 2. Un deuxième sous-réseau

Rajoutons un deuxième sous-réseau de la manière suivante (penser à bien renommer les switchs).

![](https://glassus.github.io/premiere_nsi/T3_Architecture_materielle/3.3_Architecture_reseau/data/f2.png)

### **Comment relier ces deux sous-réseaux ?**

Une réponse pas si bête : avec un cable entre les deux switchs !

![](https://glassus.github.io/premiere_nsi/T3_Architecture_materielle/3.3_Architecture_reseau/data/f3.png)
...
- **Résultat du ping**
    ...
    ![](https://glassus.github.io/premiere_nsi/T3_Architecture_materielle/3.3_Architecture_reseau/data/ft2.png)
...
- **Résultat du ping**
    ...
    ![](https://glassus.github.io/premiere_nsi/T3_Architecture_materielle/3.3_Architecture_reseau/data/ft3.png)
...
![](https://glassus.github.io/premiere_nsi/T3_Architecture_materielle/3.3_Architecture_reseau/data/f4.png)
...
- **Résultat du ping**
    ...
    ![](https://glassus.github.io/premiere_nsi/T3_Architecture_materielle/3.3_Architecture_reseau/data/ft4.png)
...
- **Exercice de bac**
    ...
    Faire les questions **Q1.** et **Q2.** de l'exercice 5 du sujet [La Réunion J1 2022](https://glassus.github.io/terminale_nsi/T6_Annales/data/2022/2022_LeReunion_J1.pdf)
    ...
    - **Correction Q2.**
        ...
        ![image](https://glassus.github.io/premiere_nsi/T3_Architecture_materielle/3.3_Architecture_reseau/data/ex5LR2022.png)
...
- Il y a donc $256^4 = 4294967296$ adresses possibles. On a longtemps cru que ce nombre serait suffisant. Ce n'est plus le cas, on est donc en train de passer sur des adresses à 6 octets (en hexadécimal) : voir la [norme IPv6](https://fr.wikipedia.org/wiki/Adresse_IPv6).

**Exemple**

![image](https://glassus.github.io/premiere_nsi/T3_Architecture_materielle/3.3_Architecture_reseau/data/ex_reseau.png)
...
![](https://glassus.github.io/premiere_nsi/T3_Architecture_materielle/3.3_Architecture_reseau/data/routeur.png)
...
![](https://glassus.github.io/premiere_nsi/T3_Architecture_materielle/3.3_Architecture_reseau/data/routeur2.png)

## 3.2 Illustration avec Filius

- Rajoutons un routeur entre le SwitchA et le SwitchB.
    
    ![](https://glassus.github.io/premiere_nsi/T3_Architecture_materielle/3.3_Architecture_reseau/data/f5.png)
...
![](https://glassus.github.io/premiere_nsi/T3_Architecture_materielle/3.3_Architecture_reseau/data/flsrouteur.png)
...
![](https://glassus.github.io/premiere_nsi/T3_Architecture_materielle/3.3_Architecture_reseau/data/passerelle.png)
...
![](https://glassus.github.io/premiere_nsi/T3_Architecture_materielle/3.3_Architecture_reseau/data/traceroute.png)
...
![](https://glassus.github.io/premiere_nsi/T3_Architecture_materielle/3.3_Architecture_reseau/data/boxmaison.png)
...
![](https://glassus.github.io/premiere_nsi/T3_Architecture_materielle/3.3_Architecture_reseau/data/imgpasserelle.jpg)
...
- Connectons un ordinateur au SwitchB, sur l'adresse `192.168.1.30` et installons dessus un Serveur web et démarrons-le.
    ...
    ![](https://glassus.github.io/premiere_nsi/T3_Architecture_materielle/3.3_Architecture_reseau/data/serveurweb.png)
...
- Sur la machine `192.168.0.1`, rajoutons un Navigateur Web. En tapant dans la barre d'adresse l'adresse IP du Serveur web, la page d'accueil de Filius s'affiche.
    ...
    ![](https://glassus.github.io/premiere_nsi/T3_Architecture_materielle/3.3_Architecture_reseau/data/nav1.png)
...
- Rajoutons un serveur DNS minimal, qui n'aura dans son annuaire d'un seul site. Il faut pour cela raccorder une nouvelle machine (mais une machine déjà sur le réseau aurait très bien pu jouer ce rôle), et installer dessus un serveur DNS.
    ...
    ![](https://glassus.github.io/premiere_nsi/T3_Architecture_materielle/3.3_Architecture_reseau/data/dns.png)
    
- Sur ce serveur DNS, associons l'adresse `http://www.vivelansi.fr` à l'adresse IP `192.168.1.30`.
    
    ![](https://glassus.github.io/premiere_nsi/T3_Architecture_materielle/3.3_Architecture_reseau/data/vivelansi.png)
    
- De retour sur notre machine `192.168.0.1`, spécifions maintenant l'adresse du serveur DNS :
    
    ![](https://glassus.github.io/premiere_nsi/T3_Architecture_materielle/3.3_Architecture_reseau/data/specdns.png)
    
- Depuis le navigateur web de la machine `192.168.0.1`, le site `http://www.vivelansi.fr` est maintenant accessible.
    
    ![](https://glassus.github.io/premiere_nsi/T3_Architecture_materielle/3.3_Architecture_reseau/data/dnsex.png)